...
function Reservation({ restId }) {
  ...
  return (
    <div className="WrapperWithoutBorder">
            ...
            {rev ? (
              <div className="bookingtable">
                <div className="colWarpper">
                  ...
                  <DetailedReservation reservations={rev1} row={1} restId={restId} />
                </div>
                <div className="colWarpper">
                  <div className="tableBorderyes">
                    {formatDate(tableDates.day1)} (D+1)
                  </div>
                  <DetailedReservation reservations={rev2} row={2} restId={restId} />
                </div>
                <div className="colWarpper">
                  <div className="tableBorderyes">
                    {formatDate(tableDates.day2)} (D+2)
                  </div>
                  <DetailedReservation reservations={rev3} row={3} restId={restId} />
                </div>
                <div className="colWarpper">
                  <div className="tableBorderyesend">
                    {formatDate(tableDates.day3)} (D+3)
                  </div>
                  <DetailedReservation reservations={rev4} row={4} restId={restId} />
                </div>
              </div>
            ):(
      ...
      <SendTalkModal TalkClose={TalkClose} talkshow={talkshow} restId={restId} />
    </div>
  );
}
