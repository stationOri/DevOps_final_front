    ...
    if (reservation.paymentStatus === "REFUND_READY") {
      return (
        <div className="my-res-refund-review">
          ...
          <div className="my-res-info-refund-total">환불될 예약금 {reservation.refund}원</div>
        </div>
      );
                      ...
                      <div key={reservation.id} className="my-res-map-box">
                        <div className="my-res-box">
                          ...
                          <div className="my-res-info-wrap">
                            <div>
                              <div className="my-res-info-rest-name">{reservation.restName}</div>
                              <div className="my-res-info-res-status">{reservation.resStatus}</div>
                            ...
                            <div className="my-res-refund-review">
                              <div className="my-res-refund-box">
                                ...
                                <div className="my-res-info-res-id">reservation id: {reservation.id}</div>
                            </div>
                          </div>
                        </div>
